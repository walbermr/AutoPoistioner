...
def preprocess_image(img_ori):
    ...
    return img_ori, img_show, circle
...
def load_image(filename, desired_res):
    ...
    @param filename: String, file to be opened within the directory.
...
def main(args):
    ...
    img_ori, img_pro, cicle_plate = preprocess_image(img_ori)
...
if __name__ == '__main__':
    ...
    main(['counter.py', './microbial-dataset-generation/data/style_dishes/6/2019-06-25_02365_nocover.jpg', 'h'])
